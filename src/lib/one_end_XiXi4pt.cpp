				...
				)
{
  ...
  for(int tsrc=0;tsrc<Nsrctime;++tsrc){
    ...
    Field proton_block;
    proton_block.reset(2, Nvol, Nc*Nc*Nd*Ndil_space*Ndil_space);
    Field neutron_block;
    neutron_block.reset(2, Nvol, Nc*Nc*Nd*Ndil_space*Ndil_space);

    Field proton_block_mspc;
    proton_block_mspc.reset(2, Nvol, Nc*Nc*Nd*Ndil_space*Ndil_space);
    Field neutron_block_mspc;
    neutron_block_mspc.reset(2, Nvol, Nc*Nc*Nd*Ndil_space*Ndil_space);
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_1=0;alpha_1<Nd;++alpha_1){ 
		  for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){ 
			...
			proton_block.add(0,v,eps.epsilon_3_index(color_123p,2)+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))), real(pb_tmp));
			proton_block.add(1,v,eps.epsilon_3_index(color_123p,2)+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))), imag(pb_tmp));
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_4=0;alpha_4<Nd;++alpha_4){ 
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){
			...
			neutron_block.add(0,v,c_3p+Nc*(eps.epsilon_3_index(color_456p,0)+Nc*(alpha_4p+Nd*(i+Ndil_space*j))), real(nb_tmp));
			neutron_block.add(1,v,c_3p+Nc*(eps.epsilon_3_index(color_456p,0)+Nc*(alpha_4p+Nd*(i+Ndil_space*j))), imag(nb_tmp));
	...
	for(int i=0;i<Ndil_space;++i){
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int c_3p=0;c_3p<Nc;++c_3p){
		  ...
		  Fmspc.add(0,v,0,
			    proton_block_mspc.cmp(0,v,c_3p+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))))
			    * neutron_block_mspc.cmp(0,v,c_3p+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))))
			    -
			    proton_block_mspc.cmp(1,v,c_3p+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))))
			    * neutron_block_mspc.cmp(1,v,c_3p+Nc*(c_4p+Nc*(alpha_4p+Nd*(i+Ndil_space*j))))
			    );
				...
				)
{
  ...
  for(int tsrc=0;tsrc<Nsrctime;++tsrc){
    ...
    Field proton_block;
    proton_block.reset(2, Nvol, Nc*Nc*Ndil_space*Ndil_space);
    Field neutron_block;
    neutron_block.reset(2, Nvol, Nc*Nc*Ndil_space*Ndil_space);

    Field proton_block_mspc;
    proton_block_mspc.reset(2, Nvol, Nc*Nc*Ndil_space*Ndil_space);
    Field neutron_block_mspc;
    neutron_block_mspc.reset(2, Nvol, Nc*Nc*Ndil_space*Ndil_space);
		  ...
		  for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){ 
			...
			(
			 ...
			 xis_2[j+Ndil_space*(beta_p  +Nd*(c_6p                             +Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_123,0),alpha_1,v,0)
		       ...
		       * xil_1_mom[i+Ndil_space*(cgm5.index(alpha_1p)+Nd*(eps.epsilon_3_index(color_123p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_123,1),cgm5.index(alpha_1),v,0);
		      proton_block.add(0,v,eps.epsilon_3_index(color_123p,2)+Nc*(c_6p+Nc*(i+Ndil_space*j)), real(pb_tmp));
		      proton_block.add(1,v,eps.epsilon_3_index(color_123p,2)+Nc*(c_6p+Nc*(i+Ndil_space*j)), imag(pb_tmp));
		  ...
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){ 
			...
			(
			 ...
			 xis_1[i+Ndil_space*(alpha_p +Nd*(c_3p                             +Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_456,0),alpha_4,v,0)
		       ...
		       * xil_2_mom[j+Ndil_space*(cgm5.index(alpha_4p)+Nd*(eps.epsilon_3_index(color_456p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_456,1),cgm5.index(alpha_4),v,0);
		      neutron_block.add(0,v,c_3p+Nc*(eps.epsilon_3_index(color_456p,2)+Nc*(i+Ndil_space*j)), real(nb_tmp));
		      neutron_block.add(1,v,c_3p+Nc*(eps.epsilon_3_index(color_456p,2)+Nc*(i+Ndil_space*j)), imag(nb_tmp));
	...
	for(int i=0;i<Ndil_space;++i){
	  for(int j=0;j<Ndil_space;++j){
	    for(int c_6p=0;c_6p<Nc;++c_6p){
		  ...
		  Fmspc.add(0,v,0,
			    proton_block_mspc.cmp(0,v,c_3p+Nc*(c_6p+Nc*(i+Ndil_space*j)))
			    * neutron_block_mspc.cmp(0,v,c_3p+Nc*(c_6p+Nc*(i+Ndil_space*j)))
			    -
			    proton_block_mspc.cmp(1,v,c_3p+Nc*(c_6p+Nc*(i+Ndil_space*j)))
			    * neutron_block_mspc.cmp(1,v,c_3p+Nc*(c_6p+Nc*(i+Ndil_space*j)))
			    );
				...
				)
{
  ...
  for(int tsrc=0;tsrc<Nsrctime;++tsrc){
    ...
    Field proton_block;
    proton_block.reset(2, Nvol, Nc*Nc*Nd*Nd*Ndil_space*Ndil_space);
    Field neutron_block;
    neutron_block.reset(2, Nvol, Nc*Nc*Nd*Nd*Ndil_space*Ndil_space);

    Field proton_block_mspc;
    proton_block_mspc.reset(2, Nvol, Nc*Nc*Nd*Nd*Ndil_space*Ndil_space);
    Field neutron_block_mspc;
    neutron_block_mspc.reset(2, Nvol, Nc*Nc*Nd*Nd*Ndil_space*Ndil_space);
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_1=0;alpha_1<Nd;++alpha_1){ 
		  for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){ 
			 ...
			 * xil_1_mom[i+Ndil_space*(cgm5.index(alpha_1p)+Nd*(eps.epsilon_3_index(color_123p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_123,1),cgm5.index(alpha_1),v,0);
			proton_block.add(0,v,eps.epsilon_3_index(color_123p,0)+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))), real(pb_tmp));
			proton_block.add(1,v,eps.epsilon_3_index(color_123p,0)+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))), imag(pb_tmp));
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_4=0;alpha_4<Nd;++alpha_4){ 
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){ 
			 ...
			 * xil_2_mom[j+Ndil_space*(cgm5.index(alpha_4p)+Nd*(eps.epsilon_3_index(color_456p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_456,1),cgm5.index(alpha_4),v,0);
			neutron_block.add(0,v,c_1p+Nc*(eps.epsilon_3_index(color_456p,0)+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))), real(nb_tmp));
			neutron_block.add(1,v,c_1p+Nc*(eps.epsilon_3_index(color_456p,0)+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))), imag(nb_tmp));
	...
	for(int i=0;i<Ndil_space;++i){
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){
		    Fmspc.add(0,v,0,
			      proton_block_mspc.cmp(0,v,c_1p+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))))
			      * neutron_block_mspc.cmp(0,v,c_1p+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))))
			      -
			      proton_block_mspc.cmp(1,v,c_1p+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))))
			      * neutron_block_mspc.cmp(1,v,c_1p+Nc*(c_4p+Nc*(alpha_1p+Nd*(alpha_4p+Nd*(i+Ndil_space*j)))))
			      );
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_4=0;alpha_4<Nd;++alpha_4){ 
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){ 
			 ...
			 * xil_2_mom[j+Ndil_space*(cgm5.index(alpha_4p)+Nd*(eps.epsilon_3_index(color_456p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_456,1),cgm5.index(alpha_4),v,0);
			neutron_block.add(0,v,c_1p+Nc*(eps.epsilon_3_index(color_456p,2)+Nc*(alpha_1p+Nd*(i+Ndil_space*j))), real(nb_tmp));
			neutron_block.add(1,v,c_1p+Nc*(eps.epsilon_3_index(color_456p,2)+Nc*(alpha_1p+Nd*(i+Ndil_space*j))), imag(nb_tmp));
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_1=0;alpha_1<Nd;++alpha_1){ 
		  for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){
			 ...
			 * xil_1_mom[i+Ndil_space*(cgm5.index(alpha_1p)+Nd*(eps.epsilon_3_index(color_123p,1)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_123,1),cgm5.index(alpha_1),v,0);
			proton_block.add(0,v,eps.epsilon_3_index(color_123p,0)+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))), real(pb_tmp));
			proton_block.add(1,v,eps.epsilon_3_index(color_123p,0)+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))), imag(pb_tmp));
	...
	for(int i=0;i<Ndil_space;++i){
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int c_1p=0;c_1p<Nc;++c_1p){
		  ...
		  Fmspc.add(0,v,0,
			    proton_block_mspc.cmp(0,v,c_1p+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))))
			    * neutron_block_mspc.cmp(0,v,c_1p+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))))
			    -
			    proton_block_mspc.cmp(1,v,c_1p+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))))
			    * neutron_block_mspc.cmp(1,v,c_1p+Nc*(c_6p+Nc*(alpha_1p+Nd*(i+Ndil_space*j))))
			    );
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int alpha_1=0;alpha_1<Nd;++alpha_1){ 
		  for(int alpha_4p=0;alpha_4p<Nd;++alpha_4p){ 
			...
			proton_block.add(0,v,c_2p+Nc*(eps.epsilon_3_index(color_456p,1)+Nc*(alpha_2p+Nd*(cgm5.index(alpha_4p)+Nd*(i+Ndil_space*j)))), real(pb_tmp));
			proton_block.add(1,v,c_2p+Nc*(eps.epsilon_3_index(color_456p,1)+Nc*(alpha_2p+Nd*(cgm5.index(alpha_4p)+Nd*(i+Ndil_space*j)))), imag(pb_tmp));
		  ...
		  for(int alpha_1p=0;alpha_1p<Nd;++alpha_1p){ 
			...
			(
			 ...
			 xis_1[i+Ndil_space*(alpha_p +Nd*(eps.epsilon_3_index(color_123p,2)+Nc*tsrc))].cmp_ri(eps.epsilon_3_index(color_456,0),alpha_4,v,0)
		      ...
		      neutron_block.add(0,v,eps.epsilon_3_index(color_123p,1)+Nc*(c_5p+Nc*(cgm5.index(alpha_1p)+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))), real(nb_tmp));
		      neutron_block.add(1,v,eps.epsilon_3_index(color_123p,1)+Nc*(c_5p+Nc*(cgm5.index(alpha_1p)+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))), imag(nb_tmp));
	  ...
	  for(int j=0;j<Ndil_space;++j){
		...
		for(int c_5p=0;c_5p<Nc;++c_5p){
		  for(int c_2p=0;c_2p<Nc;++c_2p){
		    ...
		    Fmspc.add(0,v,0,
			      proton_block_mspc.cmp(0,v,c_2p+Nc*(c_5p+Nc*(alpha_2p+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))))
			      * neutron_block_mspc.cmp(0,v,c_2p+Nc*(c_5p+Nc*(alpha_2p+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))))
			      -
			      proton_block_mspc.cmp(1,v,c_2p+Nc*(c_5p+Nc*(alpha_2p+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))))
			      * neutron_block_mspc.cmp(1,v,c_2p+Nc*(c_5p+Nc*(alpha_2p+Nd*(alpha_5p+Nd*(i+Ndil_space*j)))))
			      );
