...
int main_core(Parameters *params_conf_all)
{
  ...
  */
  ...
  int total_mom[3] = {0,0,0};

  // for inversion with source momentum
...
#pragma omp parallel for
  ...
  string output_2pt_pi("/2pt_pi_0mom_");
...
#pragma omp parallel
    ...
    idx_noise[1] = 1;
    // smeared sink
    a2a::contraction_separated_boost(Fsep_tmp, xi_l, xi_l_mom, xi_l_mom, xi_l, idx_noise, Ndil_tslice, Nsrc_t,
				     total_mom, 0);
...
#pragma omp parallel
    ...
    idx_noise[1] = 1;
    // smeared sink
    a2a::contraction_connected_boost(Fconn_tmp, xi_l_mom, xi_l_mom, xi_l, xi_l, idx_noise, Ndil_tslice, Nsrc_t,
				     total_mom, 0);
