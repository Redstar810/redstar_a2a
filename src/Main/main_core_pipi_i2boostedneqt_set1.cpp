...
int main_core(Parameters *params_conf_all)
{
  ...
  */
  ...
  //unsigned long seed;
  //seed = 1334567 - lp;//1234537 - lp; //1234509 - lp;
  ...
  */
  ...
  Fsep1_1->reset(2, Nvol, Lt);
  Fsep1_1->set(0.0);
  Field *Fsep2_2 = new Field;
  Fsep2_2->reset(2, Nvol, Lt);
  Fsep2_2->set(0.0);
  ...
  */
  ...
  Fconn1_1->reset(2, Nvol, Lt);
  Fconn1_1->set(0.0);
  Field *Fconn2_2 = new Field;
  Fconn2_2->reset(2, Nvol, Lt);
  Fconn2_2->set(0.0);
  ...
  dcomplex *Ftot1_1 = new dcomplex[Nvol*Lt];
  dcomplex *Ftot2_2 = new dcomplex[Nvol*Lt];
  for(int t_src=0;t_src<Lt;t_src++){
  ...
  for(int irank=1;irank<NPE;irank++){
    ...
    Communicator::sync_global();
    Communicator::send_1to1(2*Nvol*Lt,(double*)&F_in[0],(double*)&Ftot1_1[0],0,irank,irank);
  ...
  for(int irank=1;irank<NPE;irank++){
    ...
    Communicator::sync_global();
    Communicator::send_1to1(2*Nvol*Lt,(double*)&F_in[0],(double*)&Ftot2_2[0],0,irank,irank);
