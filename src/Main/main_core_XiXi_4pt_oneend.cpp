...
int main_core(Parameters *params_conf_all)
{
  ...
  */
  ...
  std::vector<Field_F> tcddil_noise1(Nnoise*Nsrctime*Nc*Nd);
  one_end::dirac_dil(tcddil_noise1,tcdil_noise1);
  ...
  std::vector<Field_F> tcddil_noise2(Nnoise*Nsrctime*Nc*Nd);
  one_end::dirac_dil(tcddil_noise2,tcdil_noise2);
  ...
  */
  ...
  std::vector<Field_F> dil_noise_smr1(dil_noise1.size());
  ...
  */
  ...
  // light quarks
  std::vector<Field_F> xil_1(dil_noise_smr1.size());
  std::vector<Field_F> xil_2(dil_noise_smr2.size());
  
  a2a::inversion_alt_Clover_eo(xil_1, dil_noise_smr1, U, kappa_l, csw, bc,
                               inv_prec_full, Nmaxiter, Nmaxres);
  a2a::inversion_alt_Clover_eo(xil_2, dil_noise_smr2, U, kappa_l, csw, bc,
                               inv_prec_full, Nmaxiter, Nmaxres);

  Communicator::sync_global();
  // strange quarks
  std::vector<Field_F> xis_1(dil_noise_smr1.size());
  std::vector<Field_F> xis_2(dil_noise_smr2.size());
  
  a2a::inversion_alt_Clover_eo(xis_1, dil_noise_smr1, U, kappa_s, csw, bc,
                               inv_prec_full, Nmaxiter, Nmaxres);
  a2a::inversion_alt_Clover_eo(xis_2, dil_noise_smr2, U, kappa_s, csw, bc,
                               inv_prec_full, Nmaxiter, Nmaxres);
  ...
  /*  
  { // if momentum projection is needed, please use this:
  ...
  for(int alpha=0;alpha<2;++alpha){
    ...
    */	  
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type1(XiXi4pt_type1, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type2(XiXi4pt_type2, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type3(XiXi4pt_type3, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type4(XiXi4pt_type4, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type5(XiXi4pt_type5, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  ...
	  if(mom[0] == 0 && mom[1] == 0 && mom[2] == 0){
	    ...
	    //one_end::calc_XiXi4pt_type6(XiXi4pt_type6, xis_1, xil_1_mom,  xis_2, xil_2_mom, spin_list, Nsrctime);
	  }
	  
	  Communicator::sync_global();

	  /*
	  // for non-zero mom proj. 
	  if(mom[0] != 0 || mom[1] != 0 || mom[2] != 0){
	  std::vector<Field_F>().swap(xi1_mom);
	  std::vector<Field_F>().swap(xi2_mom);
	  }
