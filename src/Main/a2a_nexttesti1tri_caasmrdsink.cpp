...
int main_core(Parameters *params_conf_all)
{
  ...
  //- dilution and noise vectors (tcds-4 dil)
  int Nnoise = 1;
  //int Nnoise_hyb = 1;
  // for tcds dilution  
  int Ndil = Lt*Nc*Nd*4;
  int Ndil_tslice = Ndil / Lt;
  std::string dil_type("tcds-s4");
  // for hybrid method
  //int Ndil_hyb = 2*Nc*Nd*8*2;
  ...
  */
  ...
  //Field_F *noise_hyb = new Field_F[Nnoise_hyb];
  ...
  */
  ...
  for(int n=0;n<Ndil_red*Nnoise;n++){
    mult_GM(tmpgm3,gm_3,dil_noise[n]);
    mult_GM(dil_noise[n],gm_5,tmpgm3);
  }
  */
  ...
  for(int n=0;n<Ndil_red*Nnoise/(Nd*4);n++){                                                                                      
    ...
    tmpgm53.set(0.0);
    axpy(tmpgm53,gm_53.value(0),xi[0+4*(0+Nd*n)]);                                                                   
    copy(chi[0+4*(0+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);
    axpy(tmpgm53,gm_53.value(0),xi[1+4*(0+Nd*n)]);                                                                                   
    copy(chi[1+4*(0+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(0),xi[2+4*(0+Nd*n)]);                                                                                   
    copy(chi[2+4*(0+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(0),xi[3+4*(0+Nd*n)]);                                                                                   
    copy(chi[3+4*(0+Nd*n)],tmpgm53);                                                                                                 
                                                                                                                                    
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(1),xi[0+4*(1+Nd*n)]);                                                                                   
    copy(chi[0+4*(1+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(1),xi[1+4*(1+Nd*n)]);                                                                                   
    copy(chi[1+4*(1+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(1),xi[2+4*(1+Nd*n)]);                                                                                   
    copy(chi[2+4*(1+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(1),xi[3+4*(1+Nd*n)]);                                                                                   
    copy(chi[3+4*(1+Nd*n)],tmpgm53);                                                                                                 
                                                                                                                                     
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(2),xi[0+4*(2+Nd*n)]);                                                                                   
    copy(chi[0+4*(2+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(2),xi[1+4*(2+Nd*n)]);                                                                                   
    copy(chi[1+4*(2+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(2),xi[2+4*(2+Nd*n)]);                                                                                   
    copy(chi[2+4*(2+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(2),xi[3+4*(2+Nd*n)]);                                                                                   
    copy(chi[3+4*(2+Nd*n)],tmpgm53);                                                                                                 
                                                                                                                                     
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(3),xi[0+4*(3+Nd*n)]);                                                                                   
    copy(chi[0+4*(3+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(3),xi[1+4*(3+Nd*n)]);                                                                                   
    copy(chi[1+4*(3+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(3),xi[2+4*(3+Nd*n)]);                                                                                   
    copy(chi[2+4*(3+Nd*n)],tmpgm53);                                                                                                 
    tmpgm53.set(0.0);                                                                                                                
    axpy(tmpgm53,gm_53.value(3),xi[3+4*(3+Nd*n)]);                                                                                   
    copy(chi[3+4*(3+Nd*n)],tmpgm53);                                                                                                 
  }                                                                             
  ...
  */
  ...
  //a2a::smearing_exp_sink(chi_smrdsink,chi,Nnoise*Ndil_red,a_sink,b_sink,thr_val_sink);
  ...
  for(int t_src=0;t_src<Nsrc_t;t_src++){
	...
	for(int t=0;t<Nt;t++){
	  for(int vs=0;vs<Nxyz;vs++){
	    for(int d=0;d<Nd;d++){
	      for(int c=0;c<Nc;c++){
		tmp2->add(0,vs+Nxyz*t,i+Ndil_tslice*(j),real(xi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*0)].cmp_ri(c,d,vs+Nxyz*t,0) * conj(evec_smrdsink[j].cmp_ri(c,d,vs+Nxyz*t,0))));
		tmp2->add(1,vs+Nxyz*t,i+Ndil_tslice*(j),imag(xi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*0)].cmp_ri(c,d,vs+Nxyz*t,0) * conj(evec_smrdsink[j].cmp_ri(c,d,vs+Nxyz*t,0))));
		tmp1->add(0,vs+Nxyz*t,i+Ndil_tslice*(j),real(evec_smrdsink[j].cmp_ri(c,d,vs+Nxyz*t,0) * conj(chi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*0)].cmp_ri(c,d,vs+Nxyz*t,0)))/eval_in[j]);
		//tmp1->add(0,vs+Nxyz*t,i+Ndil_tslice*(j),real(conj(chi[i+Ndil_tslice*(t_src+Lt*0)].cmp_ri(c,d,vs+Nxyz*t,0))));
		tmp1->add(1,vs+Nxyz*t,i+Ndil_tslice*(j),imag(evec_smrdsink[j].cmp_ri(c,d,vs+Nxyz*t,0) * conj(chi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*0)].cmp_ri(c,d,vs+Nxyz*t,0)))/eval_in[j]);
  ...
  */
  ...
  Field_F *chi_in = new Field_F;
  xi_in->reset(Nt,Ndil_red*Nnoise);
  chi_in->reset(Nt,Ndil_red*Nnoise);
  ...
  if(mygrids[0] == root_grids[0] && mygrids[1] == root_grids[1] && mygrids[2] == root_grids[2]){
	...
	for(int d=0;d<Nd;d++){
	  for(int c=0;c<Nc;c++){
	    ...
	    chi_in->set_ri(c,d,t,i,chi_smrdsink[i].cmp_ri(c,d,srcpt_exa[0]%Nx+Nx*(srcpt_exa[1]%Ny+Ny*(srcpt_exa[2]%Nz+Nz*t)),0));
	  }
	}
      }
    }
  ...
  MPI_Barrier(new_comm);
  MPI_Bcast(chi_in->ptr(0,0,0),2*Nc*Nd*Nt*Ndil_red*Nnoise,MPI_DOUBLE,root_rank,new_comm);
    
  //MPI_Comm_free(&new_comm);
  //printf("process %d : %12.4e \n",Communicator::nodeid(),xi_in->cmp_r(0,0,0,0));

  Field_F *Hinv_xi_smrdsink = new Field_F;
  Field_F *Hinv_chi_smrdsink = new Field_F;
  Hinv_xi_smrdsink->reset(Nvol,Ndil_red*Nnoise);
  Hinv_chi_smrdsink->reset(Nvol,Ndil_red*Nnoise);
	...
	for(int vs=0;vs<Nxyz;vs++){
	  for(int d=0;d<Nd;d++){
		...
		for(int cc=0;cc<Nc;cc++){
		  ...
		  tmp_value2 += Hinv_smrdsink[cc+Nc*(dd+Nd*(t+Nt*mygrids[3]))].cmp_ri(c,d,vs+Nxyz*t,0)*chi_in->cmp_ri(cc,dd,t,r);
		}
	      }
	      Hinv_xi_smrdsink->set_ri(c,d,vs+Nxyz*t,r,tmp_value1);
	      Hinv_chi_smrdsink->set_ri(c,d,vs+Nxyz*t,r,tmp_value2);
	    }
	  }
	}
      }
  ...
  for(int t_src=0;t_src<Nsrc_t;t_src++){
	...
	for(int d=0;d<Nd;d++){
	  for(int c=0;c<Nc;c++){
	    Fbox1_p2a1[v+Nvol*(t_src)] += Hinv_xi_smrdsink->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)) * conj(chi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0));
	    Fbox1_p2a2[v+Nvol*(t_src)] += conj(Hinv_chi_smrdsink->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise))) * xi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0);
  ...
  for(int n=0;n<Nsrcpt;n++){
    ...
    Field_F *chi_in_rel = new Field_F;
    xi_in_rel->reset(Nt,Ndil_red*Nnoise);
    chi_in_rel->reset(Nt,Ndil_red*Nnoise);
	...
	for(int t=0;t<Nt;t++){
	  for(int d=0;d<Nd;d++){
	    for(int c=0;c<Nc;c++){
	      ...
	      chi_in_rel->set_ri(c,d,t,i,chi_smrdsink[i].cmp_ri(c,d,srcpt_rel[0+3*n]%Nx+Nx*(srcpt_rel[1+3*n]%Ny+Ny*(srcpt_rel[2+3*n]%Nz+Nz*t)),0));
	    }
	  }
	}
      }
    ...
    MPI_Barrier(new_comm);
    MPI_Bcast(chi_in_rel->ptr(0,0,0),2*Nc*Nd*Nt*Ndil_red*Nnoise,MPI_DOUBLE,root_rank,new_comm);

    Field_F *Hinv_xi_rel = new Field_F;
    Field_F *Hinv_chi_rel = new Field_F;
    Hinv_xi_rel->reset(Nvol,Ndil_red*Nnoise);
    Hinv_chi_rel->reset(Nvol,Ndil_red*Nnoise);
	...
	for(int vs=0;vs<Nxyz;vs++){
	  for(int d=0;d<Nd;d++){
		...
		for(int cc=0;cc<Nc;cc++){
		  ...
		  tmp_value2 += Hinv_smrdsink_rel[cc+Nc*(dd+Nd*(t+Nt*mygrids[3]))].cmp_ri(c,d,vs+Nxyz*t,0)*chi_in_rel->cmp_ri(cc,dd,t,r);
		}
	      }
	      Hinv_xi_rel->set_ri(c,d,vs+Nxyz*t,r,tmp_value1);
	      Hinv_chi_rel->set_ri(c,d,vs+Nxyz*t,r,tmp_value2);
	    }
	  }
	}
      }
	...
	for(int v=0;v<Nvol;v++){
	  ...
	  for(int i=0;i<Ndil_tslice;i++){
	    for(int d=0;d<Nd;d++){
	      for(int c=0;c<Nc;c++){
		Fbox1_p2a1rel[v+Nvol*(t_src)] += Hinv_xi_rel->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)) * conj(chi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0));
		Fbox1_p2a2rel[v+Nvol*(t_src)] += conj(Hinv_chi_rel->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise))) * xi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0);
	...
	for(int i=0;i<Ndil_tslice;i++){
	  for(int d=0;d<Nd;d++){
	    for(int c=0;c<Nc;c++){
	      Fbox1_caa1[v+Nvol*(t_src)] += Hinv_xi_rel->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)) * conj(chi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0));
	      Fbox1_caa2[v+Nvol*(t_src)] += conj(Hinv_chi_rel->cmp_ri(c,d,v,i+Ndil_tslice*(t_src+Nsrc_t*idx_noise))) * xi_smrdsink[i+Ndil_tslice*(t_src+Nsrc_t*idx_noise)].cmp_ri(c,d,v,0);
