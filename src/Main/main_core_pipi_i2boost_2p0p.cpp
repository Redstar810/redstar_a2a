...
int main_core(Parameters *params_conf_all)
{
  ...
  */
  ...
  a2a::inversion_mom_alt_Clover_eo(xi_l_mom, dil_noise, U, kappa_l, csw, bc, mom_solver,
                                   Nnoise*Ndil_red, inv_prec_full,
                                   Nmaxiter, Nmaxres);
  /*
  // sink smearing
...
#pragma omp parallel for
  ...
  string output_2pt_pi("/2pt_pi_2mom_");
...
#pragma omp parallel for
    ...
    string output_4pt_sep("/NBS_sep_dt0_");
...
#pragma omp parallel for
    ...
    string output_4pt_conn("/NBS_conn_dt0_");  
